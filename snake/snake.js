...
var nums = {
    wNum: map.width / box.width,
    hNum: map.height / box.height
}
var snake = [] //蛇身体
var other = [] //蛇身体外其他部分
...
function initMap() {
    ...
    var newSpan = null
    for (var i = 1; i <= nums.wNum * nums.hNum; i++) {
...
function snakeMove() {
    ...
    for (var i = 1; i < snake.length; i++) {
        if (headId == snake[i].id) {
            alert("Game over! your final score is " + (snake.length - 5))
